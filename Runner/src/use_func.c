...
void usage_func(int ac, char **av)
{
    if ((ac == 2) && av[1][0] == '-' && av[1][1] == 'h') {
        ...
        my_putstr("The goal of this game is to avoid the enemy that appears ");
        my_putstr("in front of our characters, for this our character has ");
        my_putstr("great faculty to walk in the air.\n\n");
    }
}
